...
#define F_RET_MOTOR_AUTO_TIMEOUT_POSTER      -10401
#define F_RET_MOTOR_AUTO_OVERCURRENT         -10402
#define F_RET_MOTOR_ERROR_API_FSP            -10403
#define F_RET_MOTOR_AUTO_TIMEOUT_PULSES      -10404
